...
public class BodiesGroup {
	...
	private void validArguments(String id, ForceLaws fl) {
		// TODO Auto-generated method stub
		if(id == null || fl == null) throw new IllegalArgumentException("[ERROR]: Illegal arguments for bodies Group");
		if(id.trim().length()>0) throw new IllegalArgumentException("[ERROR]: id not including a character not void");
	}
}
